...
int Human::count=0;
//we have inherited the protected member as private  here
class Male:private Human{
    public:
       ...
       Male():Human(){
        ...
        //so we can do anything to these private memebers here in the class but cannot access them outside 
...
int main(){
    ...
    //here the public metods or function are also imherited as private cannot be accessed outside the inherited class
    cout<<m1.getcount()<<endl;
    //here this is an private member
    //when the protected data memebrs is inherited in the private mode then the resultant mode is private only 

...
int Human::count=0;
//we have inherited the protected member as protected here here
...
int main(){
    ...
    //here the public metods or function are also imherited as protrected cannot be accessed outside the inherited class
    m1.setage(90);
    cout<<m1.getage()<<endl;
    //when the protected data memebrs is inherited in the protected mode then the resultant mode is protected only 
